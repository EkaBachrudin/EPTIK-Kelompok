...
<body>
    <div class="wrapper d-flex align-items-stretch">
        <nav id="sidebar">
            ...
            <h1><a href="#" class="logo"> {{ Auth::user()->name }} </a></h1>
            <ul class="list-unstyled components">
                <li>
                    <a href="{{route('index')}}"><i class="fas fa-arrow-circle-left"></i> Web kelompok</a>
                </li>
                <li class="{{request()->is('user-admin') ? ' active' : ''}}">
                    <a href="/user-admin"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
                </li>
                <li class="{{request()->is('user-admin/post') ? ' active' : ''}}{{request()->is('user-admin/post/create') ? ' active' : ''}}">
                    <a href="/user-admin/post"><i class="fas fa-pen-fancy"></i> My Posts</a>
                </li>
                <li class="{{request()->is('user-admin/profile') ? ' active' : ''}}{{request()->is('user-admin/profile/edit') ? ' active' : ''}}">
                    <a href="/user-admin/profile"><i class="fas fa-user-cog"></i> Profile</a>
                </li>
            </ul>
        </nav>
